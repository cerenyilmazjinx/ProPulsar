...
#[derive(Debug)]
pub struct ProPulsarProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ProPulsarProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ProPulsar processing");
    
    let mut processor = ProPulsarProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ProPulsarProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ProPulsarProcessor::new(false);
